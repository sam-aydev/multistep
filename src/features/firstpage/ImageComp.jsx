            ...
            <div className='list-none relative sm:absolute sm:z-50 sm:mt-10 sm:-ml-8 '>
                <div className='flex space-x-6 pt-10 justify-center sm:pt-0 sm:flex-col sm:space-y-4  sm:space-x-0 sm:px-12 '>
                    <div className='sm:flex sm:space-x-3  '>
                        <div className=''>
                            <li className={number === 1 ? `bg-blue-200 w-7 h-7 pt-1 rounded-full text-center font-bold text-[12px]` : `w-7 h-7 text-white pt-1 rounded-full border border-white text-center font-bold text-[12px]`}>1</li>
                        </div>
